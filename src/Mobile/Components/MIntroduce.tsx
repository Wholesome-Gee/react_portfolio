...
const MIntroduce = forwardRef<HTMLDivElement>((props, ref) => {
  return (
    <Container ref={ref}>
            ...
            <TextBox>
              ...
              <Text>
                ...
                <p>
                  ...
                  <br /> 위기를 기회로, 불가능을 가능으로 만들며 얻어지는 달콤한 성취감을 얻기위해서 무한히 노력합니다.
                </p>
              </Text>
            ...
            <TextBox>
              ...
              <Text>
                ...
                <p>
                  ...
                  웹개발을 공부하며, 내가 쓴 코드들이 즉각적인 결과로 반영되는 과정을 경험하면서 성취감을 느꼈고, <br />
